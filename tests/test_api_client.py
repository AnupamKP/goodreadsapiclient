...
class TestGoodreadsAPIClient(unittest.TestCase):
    ...
    def test_book_url_diff(self):
        ...
        self.assertRaises(
            InvalidGoodreadsURL,
            self._get_book_details,
            "https://www.goodreads.com/book1/show/12177850-a-song-of-ice-and-fire",
        )
        self.assertRaises(
            InvalidGoodreadsURL, self._get_book_details, "https://www.google.com"
        )
    ...
    def test_book_url_invalid(self):
        ...
        self.assertRaises(
            InvalidGoodreadsURL,
            self._get_book_details,
            "https://www.goodreads.com/book/show/2204.The_Godfather",
        )
        self.assertRaises(
            InvalidGoodreadsURL,
            self._get_book_details,
    ...
    def test_empty_xml_data(self, mock_get_xml):
        ...
        api_response = self._get_book_details(
    ...
    def test_multiple_value(self):
        ...
        api_response = self._get_book_details(
            "https://www.goodreads.com/book/show/44890073-all-the-ways-we-said-goodbye"
        )
