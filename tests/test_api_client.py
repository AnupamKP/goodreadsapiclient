...
class TestGoodreadsAPIClient(unittest.TestCase):
    def setUp(self):
        self._client = GoodreadsAPIClient()
        self._get_book_details = self._client.get_book_details

    def test_book_url_type(self):
        """Raise InvalidGoodreadsURL Exception when the datatype of the input url is not a string 
        """
        self.assertRaises(InvalidGoodreadsURL, self._get_book_details,0)
        self.assertRaises(InvalidGoodreadsURL, self._get_book_details,0.2)
        self.assertRaises(InvalidGoodreadsURL, self._get_book_details,True)
    ...
    def test_book_url_diff(self):
        ...
        """
        self.assertRaises(InvalidGoodreadsURL, self._get_book_details,"https://www.gooreads.com/book/show/22034.The_Godfather")
        self.assertRaises(InvalidGoodreadsURL, self._get_book_details,"https://www.goodreads.com/book1/show/12177850-a-song-of-ice-and-fire")
        self.assertRaises(InvalidGoodreadsURL, self._get_book_details,"https://www.google.com")
    ...
    def test_book_url_invalid(self):
        ...
        """
        self.assertRaises(InvalidGoodreadsURL, self._get_book_details,"https://www.goodreads.com/book/show/2204.The_Godfather")
        self.assertRaises(InvalidGoodreadsURL, self._get_book_details,"https://www.goodreads.com/book/show/The_Godfather")
    ...
    def test_api_exception(self,mock_except):
        ...
        """
        self.assertRaises(InvalidGoodreadsURL, self._get_book_details,"https://www.goodreads.com/book/show/53152636-mexican-gothic")
    ...
    def test_empty_xml_data(self,mock_get_xml):
        ...
        api_response = self._get_book_details("https://www.goodreads.com/book/show/29236299-gemina")
        self.assertDictEqual({},api_response)

    def test_missing_value(self):
        """Return key's value as None when the required key doesn't exist in xml data
        """
        api_response = self._get_book_details("https://www.goodreads.com/book/show/53152636-mexican-gothic")
    ...
    def test_multiple_value(self):
        ...
        """
        api_response = self._get_book_details("https://www.goodreads.com/book/show/44890073-all-the-ways-we-said-goodbye")
        multiple_value = api_response['authors']
        self.assertEqual("Beatriz Williams, Lauren Willig, Karen White",multiple_value)

    def tearDown(self):
        self._client = None
        self._get_book_details = None
